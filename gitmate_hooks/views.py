...
def gitlab_webhook_receiver(request):
    ...
    if event == 'Issue Hook':
        ...
        # todo: not clarified upon trigger event keys
        trigger_event = {
        ...
        # TODO: clear your doubts on actions on forum
        # https://forum.gitlab.com/t/gitlab-webhooks-documentation/8389?u=nkprince007
        if pull_request['action'] in ['synchronize', 'open']:
